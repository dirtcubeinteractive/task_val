...
app.post('/test-run', async (req, res) => {
    ...
    const sequelize = new Sequelize(
        'console_specterapp_qa',
        'specterapp_admin',
        'Dirtcube2019',
        {
            host: 'console-specterapp-qa.cx8tjkw161jy.ap-south-1.rds.amazonaws.com',
            dialect: 'postgres',
            port: 5432,
            logging: false,
        }
    ...
    const mongoURI = 'mongodb://spcterapp_admin:Dirtcube2019@specterapp-qa.oufmofr.mongodb.net/specterapp-qa?retryWrites=true&w=majority'; // Replace placeholders
