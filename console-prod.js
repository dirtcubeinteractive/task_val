...
app.post('/test-run', async (req, res) => {
    ...
    const sequelize = new Sequelize(
        'console_specterapp_prod',
        'specterapp_admin',
        'Dirtcube2019',
        {
            host: 'console-specterapp-prod.cx8tjkw161jy.ap-south-1.rds.amazonaws.com',
            dialect: 'postgres',
            port: 5432,
            logging: false,
        }
    ...
    const mongoURI = 'mongodb://spcterapp_admin:Dirtcube2019@specterapp-prod.bc7vmzu.mongodb.net/specterapp-prod?retryWrites=true&w=majority'; // Replace placeholders
