...
app.post('/test-run', async (req, res) => {
    ...
    const sequelize = new Sequelize(
        'console_specterapp_dev',
        'specterapp_admin',
        'Dirtcube2019',
        {
            host: 'console-specterapp-dev.cx8tjkw161jy.ap-south-1.rds.amazonaws.com',
            dialect: 'postgres',
            port: 5432,
            logging: false,
        }
    ...
    const mongoURI = 'mongodb://spcterapp_admin:Dirtcube2019@spceterapp-dev.hvtddhv.mongodb.net/specterapp-dev?retryWrites=true&w=majority'; // Replace placeholders
